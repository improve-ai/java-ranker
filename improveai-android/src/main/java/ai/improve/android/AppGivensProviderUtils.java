...
import static ai.improve.android.AppGivensProviderImp.SP_Key_Session_Start_Time;
...
public class AppGivensProviderUtils {
    ...
    public static int getDecisionCount(Context context) {
        SharedPreferences sp = context.getSharedPreferences(SP_File_Name, Context.MODE_PRIVATE);
        return sp.getInt(SP_Key_Decision_Count, 0);
    }
